 ...
 * @author usuario
 */
public class BuscarGenericoBackup extends javax.swing.JFrame {
    ...
    public BuscarGenericoBackup() {
        initComponents();
    }

    public BuscarGenericoBackup(Organizacion organizacion, JFrame ventanaAnterior, String trayectoriaAnterior) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarGenericoBackup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarGenericoBackup().setVisible(true);
            }
        });
    }
