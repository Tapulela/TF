 ...
 * @author usuario
 */
public class BuscarMolienda extends javax.swing.JFrame implements TransferenciaInstancias{
    ...
    public BuscarMolienda() {
        initComponents();
    }

    public BuscarMolienda(Organizacion organizacion, JFrame ventanaAnterior, String trayectoriaAnterior) {
        ...
        this.trayectoriaActual = trayectoriaAnterior + " - Búsqueda de Molienda";
        
        cabeceraDeVentana.configurarCabecera(ventanaAnterior, this, "Búsqueda de una molienda", this.trayectoriaActual, organizacion.getUsuarioActivo().getApellido()+", "+organizacion.getUsuarioActivo().getNombre());
        ...
        if (ventanaAnterior instanceof GestionEgresos){   //EJEMPLO GENERICO, ESTO DEBERIA CAMBIARSE
            GestionEgresos gestionEgreso = (GestionEgresos) ventanaAnterior;
            jCBCriterio1.doClick();
            jCBCriterio1.setEnabled(false);
            botonCriterio1.setEnabled(false);
            this.unMolinoSeleccionado = gestionEgreso.getUnMolino();
            this.exhibirMolino();
            
            jCBCriterio2.doClick();
            botonCriterio2.setEnabled(false);
            jCBCriterio2.setEnabled(false);
            this.unaOrdenDeProduccion = gestionEgreso.getUnaOrdenProduccionSeleccionada();
            this.exhibirOrdenProduccion();
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Molino asociado", "Estado", "Fecha de origen"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            listaFiltrada = this.organizacion.filtrarMoliendasNoEgresadas(this.criteriosSeleccionados, this.unMolinoSeleccionado, this.unaOrdenDeProduccion, this.unLoteSeleccionado, (String) datoCriterio4.getSelectedItem(), dato1Criterio5.getCalendar(), dato2Criterio5.getCalendar());
            ...
            while (estacionamientos.hasNext()){
                Molienda unaMolienda = (Molienda) estacionamientos.next();    
                ((DefaultTableModel)this.jTable1.getModel()).addRow(unaMolienda.devolverVector());
            }
...
//      TENGO QUE HACER UNA BUSQUEDA DE LOTES QUE PERMITA ELEGIR COMO CRITERIO A LOS EQUIPAMIENTOS.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarMolienda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarMolienda().setVisible(true);
            }
        });
    }
