 ...
 * @author usuario
 */
public class RegistrarIngreso extends javax.swing.JFrame implements TransferenciaInstancias {
    ...
    RegistrarIngreso(Organizacion organizacion, JFrame ventanaAnterior, String trayectoriaAnterior) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLOperacion.setText("Ingreso de un nuevo lote");
        ...
        jLStaticEquipamientoOrigen.setText("Equipamiento donde llega el nuevo lote");
        ...
        jLStaticDetallesTicket.setText("Detalles del Ticket de Movimeinto asociado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(RegistrarIngreso.class.getName()).log(Level.SEVERE, null, ex);
        }
        //</editor-fold>
