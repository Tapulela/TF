 ...
 * @author usuario
 */
public class BuscarMovimientoMateriaPrima extends javax.swing.JFrame implements TransferenciaInstancias{
    ...
    public BuscarMovimientoMateriaPrima() {
        initComponents();
    }

    public BuscarMovimientoMateriaPrima(Organizacion organizacion, JFrame ventanaAnterior, String trayectoriaAnterior) {
        ...
        this.trayectoriaActual = trayectoriaAnterior + " - Busqueda de movimientos de materia prima";
        
        cabeceraDeVentana.configurarCabecera(ventanaAnterior, this, "Busqueda de movimientos de materia prima", this.trayectoriaActual, organizacion.getUsuarioActivo().getApellido()+", "+organizacion.getUsuarioActivo().getNombre());
    ...
    private void initComponents() {
        ...
        jCBCriterio5.setText("Equipamiento donde se registro el origen del movimiento");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(jLCriterio7, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Estado", "ID O,P.", "ID O.C.", "Origen", "Destino", "Proveedor", "fecha", "Etiqueta"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            listaFiltrada = this.organizacion.filtrarMovimientos(this.criteriosSeleccionados, (String)datoCriterio1.getSelectedItem(), datoCriterio2.getText(), unaOrdenDeProduccionSeleccionada, unaOrdenDeCompraSeleccionada, equipamientoDestinoSeleccionado, unProveedorTransporteSeleccionado, unProveedorTransporteSeleccionado, dato1Criterio8.getCalendar(), dato2Criterio8.getCalendar());
            
            ((DefaultTableModel)this.jTable1.getModel()).setRowCount(0);
            Iterator movimientos = listaFiltrada.iterator();
            while (movimientos.hasNext()){
                MovimientoInternoMateriaPrima unMovimiento = (MovimientoInternoMateriaPrima) movimientos.next();    
                ((DefaultTableModel)this.jTable1.getModel()).addRow(unMovimiento.devolverVectorMovimiento());
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        this.unObjetoSeleccionado = this.organizacion.getMovimientos().get(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarMovimientoMateriaPrima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarMovimientoMateriaPrima().setVisible(true);
            }
        });
    }
